...
# os.environ["LANGSMITH_API_KEY"] = "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"
...
def search_similar_documents(
    ...
    if verbose:
        ...
        for item in search_results:
            print("=" * 100)
            print("id:", item["id"])
            print("member_id:", item["member_id"])
...
# ============================================================
# RAG 검색 결과를 LLM Context 문자열로 변환 (객체 -> 문자열)
# ============================================================
...
# "https://ai.iranglab.com"
if __name__ == "__main__":
    question = "서예진의 건강검진 결과를 설명해줘"
